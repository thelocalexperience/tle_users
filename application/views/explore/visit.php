<?=$this->load->view('layouts/header');?>
	...
	<div id="thirdrow">
		<hgroup id="heading" class="rounded-2 shadowed">Morning Activity</hgroup>
		<hgroup id="heading" class="rounded-2 shadowed spaced">Afternoon Activity</hgroup>
		<hgroup id="heading" class="rounded-2 shadowed spaced">Night Activity</hgroup>
	</div>
