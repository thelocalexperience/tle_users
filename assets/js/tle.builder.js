...
$(document).ready(function() {			
	...
	$('#create-row').mouseover(function() {
		$('#create-row a').css('background-position','0 -24px');
		$('#create-row a').css('color','#fff');
	});
	
	$('#create-row').mouseout(function() {
		$('#create-row a').css('background-position','0 0');
		$('#create-row a').css('color','#d0d0d0');
	});
	
	$('#create-row').click(function() {
		if ($('.update-row').is(":visible")) { $('.update-row').slideUp('slow'); }
		else { $('.update-row').slideDown('slow'); }
	});
